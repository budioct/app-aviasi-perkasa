...
import com.aviasi.perkasa.services.TravelService;
...
@RestController
@RequestMapping(Constants.API_TRAVEL)
...
////                response = travelService.getall();
//                response = travelService.getalldua();
...
//
//            if (resChecktoken.get(Constants.STATUS_CODE).equals("00")){
//                response = travelService.byid(id);
//                return new ResponseEntity<>(response, HttpStatus.OK);
//            }else {
//                response = resChecktoken;
//                return new ResponseEntity<>(response, HttpStatus.BAD_REQUEST);
...
//    }
    ...
    public ResponseEntity<Map<String, Object>> getByid(
        ...
        try {
            if (resChecktoken.get(Constants.STATUS_CODE).equals("00")) {
                response = travelService.getById(id);
                return new ResponseEntity<>(response, HttpStatus.OK);
    ...
    public ResponseEntity<Map<String, Object>> delete(
        ...
        try {
            if (resChecktoken.get(Constants.STATUS_CODE).equals("00")) {
                ...
                response = travelService.delete(id);
                return new ResponseEntity<>(response, HttpStatus.OK);
            } else {
                response = resChecktoken;
                return new ResponseEntity<>(response, HttpStatus.BAD_REQUEST);
    ...
    public ResponseEntity<Map<String, Object>> save(
        ...
        try {
            ...
            if (resChecktoken.get(Constants.STATUS_CODE).equals("00")) {
                response = travelService.save(req);
                return new ResponseEntity<>(response, HttpStatus.OK);
            } else {
                response = resChecktoken;
                return new ResponseEntity<>(response, HttpStatus.BAD_REQUEST);
    ...
    public ResponseEntity<Map<String, Object>> edit(
        ...
        try {
            if (resChecktoken.get(Constants.STATUS_CODE).equals("00")) {
                response = travelService.edit(req, id);
                return new ResponseEntity<>(response, HttpStatus.OK);
            } else {
                response = resChecktoken;
                return new ResponseEntity<>(response, HttpStatus.BAD_REQUEST);
