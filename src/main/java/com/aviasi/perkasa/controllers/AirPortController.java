...
import com.aviasi.perkasa.services.AirPortService;
...
@RestController
@RequestMapping(Constants.API_AIRPORT)
public class AirPortController {
    ...
    public ResponseEntity<Map<String, Object>> getall(
        ...
        try {
            ...
            if (resChecktoken.get(Constants.STATUS_CODE).equals("00")) {
                response = airPortService.getAll();
    ...
    public ResponseEntity<Map<String, Object>> getById(
        ...
        try {
            ...
            if (resChecktoken.get(Constants.STATUS_CODE).equals("00")) {
                response = airPortService.getById(id);
                return new ResponseEntity<>(response, HttpStatus.OK);
            } else {
                response = resChecktoken;
                return new ResponseEntity<>(response, HttpStatus.BAD_REQUEST);
    ...
    public ResponseEntity<Map<String,Object>> save(
        ...
        try{
            ...
            if (resChecktoken.get(Constants.STATUS_CODE).equals("00")){
                response = airPortService.save(req);
                return new ResponseEntity<>(response, HttpStatus.OK);
            }else {
                response = resChecktoken;
                return new ResponseEntity<>(response, HttpStatus.BAD_REQUEST);
    ...
    public ResponseEntity<Map<String, Object>> delete(
        ...
        try{
            ...
            if (resChecktoken.get(Constants.STATUS_CODE).equals("00")){
                response = airPortService.delete(id);
                return new ResponseEntity<>(response, HttpStatus.OK);
            }else {
                response = resChecktoken;
                return new ResponseEntity<>(response, HttpStatus.BAD_REQUEST);
    ...
    public ResponseEntity<Map<String, Object>> edit(
        ...
        try{
            ...
            if (resChecktoken.get(Constants.STATUS_CODE).equals("00")){
                response = airPortService.edit(req, id);
                return new ResponseEntity<>(response, HttpStatus.OK);
            }else{
                response = resChecktoken;
                return new ResponseEntity<>(response, HttpStatus.BAD_REQUEST);
